...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/task":"7jDg7"}],"ky8MP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class View {
    ...
    _chooseOperation(operation) {
        ...
        // Calculate
        if (this.historyOperand !== "") this._compute();
    ...
    _updateDisplay() {
        ...
        if (this.operation != null) this._history.innerText = `${this.getDisplayNumber(this.historyOperand)} ${this.operation}`;
        else this._history.innerText = "";
    }
    // Clear display
    clear() {
        this.historyOperand = "";
...
},{}]},["fA0o9","aenu9"], "aenu9", "parcelRequirebbb8")
